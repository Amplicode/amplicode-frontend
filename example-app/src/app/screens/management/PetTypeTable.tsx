...
const REFETCH_QUERIES = ["Get_Pet_Type_List"];
...
export function PetTypeTable() {
  const intl = useIntl();
  useBreadcrumbItem(intl.formatMessage({ id: "screen.PetTypeTable" }));
...
function useDeleteConfirm(id: string | null | undefined) {
  ...
  const [runDeleteMutation, { loading }] = useMutation(DELETE_PET_TYPE);
 ...
 */
type ItemTableType = QueryResultType["petTypeList"];
/**
