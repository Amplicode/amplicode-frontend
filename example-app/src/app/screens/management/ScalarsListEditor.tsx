...
export interface ScalarsListEditorProps<TData = any> {
  /**
...
export function ScalarsListEditor({
  refetchQueries
}: ScalarsListEditorProps<QueryResultType>) {
  const intl = useIntl();
  useBreadcrumbItem(intl.formatMessage({ id: "screen.ScalarsListEditor" }));
