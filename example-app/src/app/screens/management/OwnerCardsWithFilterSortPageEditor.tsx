...
export interface OwnerCardsWithFilterSortPageEditorProps<TData = any> {
  /**
...
export function OwnerCardsWithFilterSortPageEditor({
  refetchQueries
}: OwnerCardsWithFilterSortPageEditorProps<QueryResultType>) {
  const intl = useIntl();
  useBreadcrumbItem(
    intl.formatMessage({ id: "screen.OwnerCardsWithFilterSortPageEditor" })
  );
