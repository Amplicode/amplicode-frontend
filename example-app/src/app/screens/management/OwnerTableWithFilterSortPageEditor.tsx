...
export interface OwnerTableWithFilterSortPageEditorProps<TData = any> {
  /**
...
export function OwnerTableWithFilterSortPageEditor({
  refetchQueries
}: OwnerTableWithFilterSortPageEditorProps<QueryResultType>) {
  const intl = useIntl();
  useBreadcrumbItem(
    intl.formatMessage({ id: "screen.OwnerTableWithFilterSortPageEditor" })
  );
