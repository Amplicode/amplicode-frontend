...
import { OwnerCardsWithFilterSortPage } from "./OwnerCardsWithFilterSortPage";
import { OwnerCardsWithFilterSortPageEditor } from "./OwnerCardsWithFilterSortPageEditor";
import { BreadcrumbContext } from "../../../core/screen/BreadcrumbContext";
import { usePageTitle } from "../../../core/screen/usePageTitle";
import { useIntl } from "react-intl";

export function OwnerCardsWithFilterSortPageScreenLayout() {
  const intl = useIntl();
  usePageTitle(
