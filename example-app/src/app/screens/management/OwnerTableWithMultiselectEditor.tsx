...
export interface OwnerTableWithMultiselectEditorProps<TData = any> {
  /**
...
export function OwnerTableWithMultiselectEditor({
  refetchQueries
}: OwnerTableWithMultiselectEditorProps<QueryResultType>) {
  const intl = useIntl();
  useBreadcrumbItem(
    intl.formatMessage({ id: "screen.OwnerTableWithMultiselectEditor" })
  );
