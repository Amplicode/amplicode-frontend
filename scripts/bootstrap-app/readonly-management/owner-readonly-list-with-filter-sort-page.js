...
const answers = btoa(JSON.stringify({
  listComponentName: 'ReadOnlyOwnerListWithFilterSortPage',
  itemComponentName: 'ReadOnlyOwnerListWithFilterSortPageDetails',
  route: 'read-only-owner-list-with-filter-sort-page',
  type: 'list',
