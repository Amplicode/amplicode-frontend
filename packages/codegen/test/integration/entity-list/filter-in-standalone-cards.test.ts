...
describe('codegen filter in standalone cards', () => {
  ...
  it('standalone cards with filter', async () => {
    ...
    expect(componentFile).to.contain('<Filters onApplyFilters={applyFilters} />');
  ...
  it('standalone cards without filter', async () => {
    ...
    expect(componentWithoutFilterFile).to.not.contain('<Filters onApplyFilters={applyFilters} />');
  ...
  it('standalone cards with empty filter', async () => {
    ...
    expect(componentWithNullFilterFile).to.not.contain('<Filters onApplyFilters={applyFilters} />');
    ...
    expect(componentWithEmptyArrayFilterFile).to.not.contain('<Filters onApplyFilters={applyFilters} />');
